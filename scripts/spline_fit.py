...
if __name__ == '__main__':
    ...
    omega = np.array([
        data_usd['fixedFrequency'][f'ctrlLee.omegax'],
        data_usd['fixedFrequency'][f'ctrlLee.omegay'],
        data_usd['fixedFrequency'][f'ctrlLee.omegaz']]).T
    ...
    rpy = np.array([
        data_usd['fixedFrequency'][f'ctrlLee.rpyx'],
        data_usd['fixedFrequency'][f'ctrlLee.rpyy'],
        data_usd['fixedFrequency'][f'ctrlLee.rpyz']]).T
    import rowan
    ...
    g = np.array([0,0,-9.81])
    # fa = mass * acc - mass * g - rowan.rotate(q, u)
    # print(fa)

    # a_rpm_filtered = np.array([
    #     data_usd['fixedFrequency'][f'ctrlLee.a_rpm_fx'],
    #     data_usd['fixedFrequency'][f'ctrlLee.a_rpm_fy'],
    #     data_usd['fixedFrequency'][f'ctrlLee.a_rpm_fz']]).T
    
    # a_imu_filtered = np.array([
    #     data_usd['fixedFrequency'][f'ctrlLee.a_imu_fx'],
    #     data_usd['fixedFrequency'][f'ctrlLee.a_imu_fy'],
    #     data_usd['fixedFrequency'][f'ctrlLee.a_imu_fz']]).T

    # fig, ax = plt.subplots(1, 3, sharex='all', squeeze=False)
    # for k, axis in enumerate(["x", "y", "z"]):
    #     ax[0,k].plot(t, fa[:,k], label="fa")
    #     ax[0,k].plot(t, -(a_rpm_filtered-a_imu_filtered)[:,k]*mass, label="fa")
    ...
    tau_rpm_filtered = np.array([
        data_usd['fixedFrequency'][f'ctrlLee.tau_rpm_fx'],
        data_usd['fixedFrequency'][f'ctrlLee.tau_rpm_fy'],
        data_usd['fixedFrequency'][f'ctrlLee.tau_rpm_fz']]).T
        
    tau_imu_filtered = np.array([
        data_usd['fixedFrequency'][f'ctrlLee.tau_gyro_fx'],
        data_usd['fixedFrequency'][f'ctrlLee.tau_gyro_fy'],
        data_usd['fixedFrequency'][f'ctrlLee.tau_gyro_fz']]).T 
